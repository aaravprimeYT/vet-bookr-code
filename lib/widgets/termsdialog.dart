...
//                     child: Text("1. Ability to Contract.",
//                         style: TextStyle(
...
//                     padding:
//                         EdgeInsets.only(bottom: 10.0, left: 10.0, right: 10.0),
//                     child: Text("4. Intellectual Property",
//                         style: TextStyle(
//                             fontSize: 14, fontWeight: FontWeight.bold)),
//                   ),
//                   Padding(
...
//                     padding:
//                         EdgeInsets.only(bottom: 10.0, left: 10.0, right: 10.0),
//                     child: Text("7. Termination of Account",
//                         style: TextStyle(
//                             fontSize: 14, fontWeight: FontWeight.bold)),
//                   ),
//                   Padding(
